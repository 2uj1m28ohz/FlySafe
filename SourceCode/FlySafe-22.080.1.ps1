...
function CarregarInterface {
	...
	$script:Suporte_RemoverEventosTitulo = "MENU $ElementoSeparador SUPORTE $ElementoSeparador REMOVER EVENTOS"
...
function Configuracoes_HabilitarEventos {
	...
	if ((Test-Path "$DiretorioSoftware\$ArquivoConfiguracoes") -eq $True) {
		...
		$SoftwareConfiguracoes | ConvertTo-Json | Out-File -Path "$DiretorioSoftware\$ArquivoConfiguracoes" -Force
